...
// this function creates a three-column table and adds it to the screen
   ...
   tocTable += '<table>';
   tocTable += '<th style="text-align: center">';
   ...
   for (var i = 0; i < postTitle.length; i++) {
      if (filter == '') {
         tocTable += '<th><td class="toc-entry-col1"><a href="' + postUrl[i] + '" title="' + postSum[i] + '">' + postTitle[i] + '</a></td><td class="toc-entry-col2">' + postDate[i] + '</td><td class="toc-entry-col3">' + postLabels[i] + '</td></th>';
         numDisplayed++;
      } else {
